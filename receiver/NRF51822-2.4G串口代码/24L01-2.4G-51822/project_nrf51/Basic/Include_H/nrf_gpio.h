 ...
 * set.
 */
static __INLINE void nrf_gpio_pin_set(uint32_t pin_number)//置位一个io脚
{
 ...
 * clear.
 */
static __INLINE void nrf_gpio_pin_clear(uint32_t pin_number)//复位一个io脚
{
